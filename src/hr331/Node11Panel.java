 ...
 *创建人:an
 *修改备注:
 *			1.解决不能连续添加新员工的问题（获取最新员工ID至text）
 *			
 *@version 1.0.1
 */
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == add){//选择添加按钮
			...
			if(nameText.getText().trim().length()!=0) {
				...
				JOptionPane.showMessageDialog(null, "插入信息成功!");//提示信息
				clearAll();//清空
				pIdText.setText(""+pbean.getID());//解决无法连续添加新员工的问题
			}else
				JOptionPane.showMessageDialog(null, "请至少输入姓名以添加一名新员工！");
